...
test('correction: happened -> therapist_cancelled flips pay to 0 on the SAME row', () => {
  ...
  let r = recordSessionOutcome(
    { sessionId: 'fix1', therapist: 'תמר גנץ', clinicalTreatmentType: 'פרטני כללי', outcome: 'happened' }, rows
  );
  rows = r.rows;
  ...
  r = recordSessionOutcome(
    { sessionId: 'fix1', therapist: 'תמר גנץ', clinicalTreatmentType: 'פרטני כללי', outcome: 'therapist_cancelled' }, rows
  );
  rows = r.rows;
